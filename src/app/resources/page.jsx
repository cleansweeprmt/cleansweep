...
const Page = () => {
  return (
    <div className="">
      ...
      <section className="container mx-auto px-5 lg:px-20 bg-white -mt-10 lg:-mt-10 grid grid-cols-1 lg:grid-cols-4 mb-10 gap-10">
        <div className="shadow-xl h-[250px] flex flex-col items-center justify-center z-20 rounded-lg gap-4 bg-gray-100">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z" />
        ...
        <div className="shadow-xl h-[250px] flex flex-col items-center justify-center z-20 rounded-lg gap-4 bg-gray-100 p-4 text-center">
          <svg
