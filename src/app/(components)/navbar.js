    ...
    <div className="container-fluid bg-secondary fixed w-full z-20">
      <div className=" container mx-auto lg:px-20 bg-primary text-white text-xs hidden lg:flex items-center px-3 py-2 justify-between z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <svg className="w-6 h-6" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M30.75 10.25C31.575 11.175 32.5125 11.8125 33.4875 12.1125C34.3125 12.3625 35.2125 12.5 36 12.5V19.3125C35.3125 19.375 34.575 19.375 33.9 19.25C31.3875 18.8125 29.8875 17.1875 29.8875 17.1875V30.75C29.8875 35.1125 26.2375 38.8125 21.8125 38.8125C17.55 38.8125 14 35.2625 14 31C14 26.7375 17.4875 23.3125 21.75 23.3125C22.7625 23.3125 23.725 23.5375 24.5875 23.925V30.1875C24.5875 32.05 23.0875 33.625 21.25 33.625C19.45 33.625 18 32.175 18 30.375C18 28.575 19.45 27.125 21.25 27.125C21.725 27.125 22.15 27.2375 22.5 27.45V20.3875C20.05 20.725 18.125 22.925 18.125 25.4375C18.125 28.1125 20.325 30.3125 23 30.3125C25.675 30.3125 27.875 28.1125 27.875 25.4375V6.5H30.75V10.25Z" fill="white"/>
          </svg>
          <svg className="w-6 h-6" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
