    ...
    <div className="container-fluid bg-white fixed w-full z-20">
      <div className=" container mx-auto lg:px-20 bg-primary text-white text-xs hidden lg:flex items-center px-3 py-2 justify-between z-10">
        ...
        {/* <div className="flex items-center gap-2">
          ...
          <a href="https://www.facebook.com/profile.php?id=100077643974033" target="blank" aria-label="visit our facebook page">
          ...
          <a href="https://x.com/HRFleek" target="blank" aria-label="visit our twitter page">
          <svg className="w-6 h-6" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.tiktok.com/@hrfleek_kenya?_t=8mnygT77gwv&_r=1" target="blank" aria-label="visit our tiktok page">  <svg className="h-6 w-6" fill="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
