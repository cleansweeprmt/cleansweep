...
const Page = () => {
  ...
  const topics = [
    {
      title: "Expanding Access to Care in Underserved Communities.",
      content:
        "Discussing challenges and solutions for providing critical maternal and infant care to all.",
    },
    {
      title: "Innovations in Neonatal Care: Saving the Smallest Lives.",
      content:
        "Exploring the latest advancements in technology and treatment for premature or critically ill newborns.",
    },
    {
      title: "The Power of Community Support: Empowering Mothers Through Resources.",
      content:
        "Discover how community programs provide education, mental health support, and essential resources for mothers.",
    },
    {
      title: "Policy and African AI Ethics/Data Transformation in Africa",
      content:
        "Examining AI policy development and ethics in Africa, focusing on responsible AI adoption.",
    },
    {
      title: " Supporting Maternal Wellbeing During Pregnancy and Beyond.",
      content:
        "Discussing the importance of addressing postpartum depression and anxiety, highlighting resources for mothers.",
    },
    {
      title: "Dads Matter Too: The Role of Fathers in Maternal and Infant Health.",
      content:
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://api.adanianlabs.io/api/v1/attendance",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div>
      <section className="py-5 lg:py-28 gala-hero relative">
        ...
        <div className="flex flex-col items-center justify-start gap-5">
          ...
          <div className="bg-white rounded flex items-center justify-between py-2 shadow-md px-4 gap-5 z-10">
            ...
            <p className="text-md text-gray-500">25, May, 2024</p>{" "}
            <hr className="w-[2px] h-10 bg-gray-300"></hr>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <main className=" min-h-screen flex-col items-center justify-between bg-secondary container mx-auto px-5 lg:px-20">
        ...
        <section class="about relative" id="about-id">
          <div className="">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-5">
                {topics.map((topic) => (
                  <div className="topics-card space-y-5 p-5">
                    <h3 className="text-dark text-lg font-semibold">{topic.title}</h3>
                    <p className="text-md text-dim">{topic.content}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* <section>
          <Modal isOpen={isModalOpen} onClose={() => setModalOpen(false)}>
            <div className="flex flex-col md:flex-row gap-10 m-5">
              ...
              ></img>
              <p className="h-40 md:h-fit overflow-y-auto">
                {speakerDetails?.bio}
              </p>
            </div>
          </Modal>
          ...
          <div className="">
            <div class="about-cards ">
              ...
              <h3 className="text-[#F39711] text-center ">
                OUR AMAZING SPEAKERS
              </h3>
              <h1 className="text-[32px] md:text-[44px] text-center">
                The talented <span className="text-[#F39711]">Speakers</span>{" "}
                that will be joining us!
              </h1>
              <p className="text-center my-3">
                Speakers from leading tech industries from Africa & the
                Diaspora.
              </p>
              <div className="flex justify-between items-center flex-wrap my-10">
                <div
                  className="h-[360px] w-[360px] rounded-full object-contain bg-center bg-cover relative group hover:overlay"
                  style={{ backgroundImage: "url('/img/speakers/sharola.jpg')" }}
                >
                ...
                <div
                  className="h-[360px] w-[360px] rounded-full object-contain  bg-cover relative group hover:overlay "
                  style={{ backgroundImage: "url('/img/speakers/sharola.jpg')" }}
                >
                  <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                    <div>
                      ...
                      <p
                        ...
                        style={{ fontSize: "10px" }}
                      >
                        Ethical artificial intelligence, blockchain, and climate
                        change
                      </p>
                      <h3
                        className="text-black text-center mt-3 cursor-pointer"
                ...
                <div className="flex justify-between">
                  <div className="space-y-3">
                    <div
                      className="h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay"
                      style={{
                        backgroundImage: "url('/img/speakers/sharola.jpg')",
                      }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            Co-founder, Chairman and Director of Education at
                            London School of Leadership
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                            onClick={() =>
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p className="text-white text-center">
                            the Ecosystem Manager at Turing Innovation Catalyst
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                            onClick={() =>
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            Ms. MSc Applied AI and Data Analytics, LLB Hons, LLM
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                            onClick={() =>
              ...
              <div className="flex items-center justify-center flex-wrap gap-10">
                <div className="flex flex-col md:flex-row gap-10">
                  <div className="space-y-3 flex flex-row md:flex-col items-center">
                    <div
                      className="h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay"
                      style={{ backgroundImage: "url('/speakers/jossi.jpg')" }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            BA Hons : MSc | D.E.I. Fair FinTech Inventor |
                            Adviser | Investor
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                    ...
                    <div
                      className=" z-10 h-[160px] w-[160px] rounded-full object-contain  bg-contain relative group hover:overlay"
                      style={{ backgroundImage: "url('/speakers/troy.jpg')" }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                  ...
                  <div className="space-y-3 flex flex-row md:flex-col items-center">
                    <div
                      className="h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay"
                      style={{
                        backgroundImage: "url('/speakers/jackson.jpg')",
                      }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            Adanian Labs UK Senior Developer & Data Scientis
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                            onClick={() =>
                    ...
                    <div
                      className="z-10 h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay"
                      style={{ backgroundImage: "url('/speakers/sherin.jpg')" }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            Founder & CEO of AI Tech UK | AI Ethicist & Futurist
                            | Chief AI Officer
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  <div className="space-y-3  flex flex-row md:flex-col items-center">
                    <div
                      className="z-10 h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay"
                      style={{ backgroundImage: "url('/speakers/wayne.jpg')" }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            Director & Founder; MADE4TECHGLOBAL
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                            onClick={() =>
                    ...
                    <div
                      className="z-10 h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay"
                      style={{ backgroundImage: "url('/speakers/wafula.jpg')" }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            Senior Data Scientist and Commercial lead at AICE
                            Africa{" "}
                          </p>
                          <h3
                            className="text-black text-center mt-3 cursor-pointer"
                  ...
                  <div className="space-y-3  flex flex-row md:flex-col items-center">
                    <div
                      className="z-10 h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay bg-center"
                      style={{ backgroundImage: "url('/speakers/seun.jpg')" }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div>
                          ...
                          <p
                            ...
                            style={{ fontSize: "10px" }}
                          >
                            senior lecturer (associate professor) in Data
                    ...
                    <div
                      className="h-[160px] w-[160px] rounded-full object-contain  bg-cover relative group hover:overlay"
                      style={{
                        backgroundImage: "url('/speakers/michaels.jpeg')",
                      }}
                    >
                      <div className="absolute inset-0 bg-[#F39711CC] opacity-0 group-hover:opacity-50 rounded-full"></div>
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
            ...
            <div class="about-cards py-4">
                ...
                <div className="highlights-card space-y-4 border-b-2 border-r-2 border-solid border-b-[#F39711CC] border-r-[#F39711CC] p-5">
                  ...
                  >
                    <g clip-path="url(#clip0_135_637)">
                      ...
                      />
                      <path
                        d="M25.5425 36.6704C25.7401 36.1192 25.8961 35.62 26.1769 35.152C26.4681 34.6632 26.8529 34.4136 27.4561 34.4344C28.6209 34.4656 29.7961 34.4656 30.9609 34.4344C31.5433 34.424 31.9177 34.6632 32.1985 35.1312C32.4793 35.5888 32.6457 36.0984 32.8433 36.6912C33.0617 36.0672 33.2281 35.5264 33.5505 35.0376C33.8209 34.6216 34.1745 34.424 34.6841 34.424C35.8801 34.4448 37.0865 34.4448 38.2929 34.424C38.8337 34.4136 39.1873 34.632 39.4681 35.0584C39.7801 35.5368 39.9257 36.088 40.1649 36.6496C40.3521 36.0568 40.5393 35.5264 40.8409 35.0376C41.1217 34.6008 41.4961 34.4032 42.0265 34.4136C43.1913 34.4344 44.3665 34.4448 45.5313 34.4136C46.1553 34.3928 46.5505 34.6632 46.8417 35.1728C47.3929 36.14 47.5905 37.2008 47.7361 38.2824C47.8089 38.8648 47.8089 39.4472 47.8609 40.0296C47.8817 40.2688 47.8193 40.3728 47.5593 40.3416C47.4761 40.3312 47.3929 40.3416 47.3097 40.3416C37.6689 40.3416 28.0177
z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M31.9799 21.1329C31.9799 21.9337 31.2935 22.5993 30.4927 22.5785C29.7023 22.5681 29.0471 21.9129 29.0471 21.1329C29.0471 20.3321 29.7335 19.6665 30.5343 19.6769C31.3247 19.6977 31.9799 20.3633 31.9799 21.1329Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M45.9159 21.112C45.9263 21.9232 45.2607 22.5784 44.4495 22.5784C43.6591 22.568 43.0039 21.9232 42.9935 21.1432C42.9831 20.3528 43.6695 19.6768 44.4703 19.6768C45.2503 19.6872 45.9055 20.332 45.9159 21.112Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M27.3209 21.164C27.3105 21.9752 26.6345 22.6096 25.8129 22.5784C25.0225 22.5576 24.3777 21.8816 24.3881 21.112C24.4089 20.3424 25.0745 19.6872 25.8545 19.6768C26.6761 19.6872 27.3417 20.3632 27.3209 21.164Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M33.7063 21.1327C33.7063 20.3423 34.3511 19.6975 35.1415 19.6871C35.9423 19.6767 36.6287 20.3631 36.6287 21.1535C36.6183 21.9335 35.9735 22.5783 35.1831 22.5887C34.3615 22.5887 33.7063 21.9439 33.7063 21.1327Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M22.6721 21.1119C22.6825 21.9127 22.0585 22.5679 21.2577 22.5887C20.4361 22.6095 19.7705 21.9543 19.7705 21.1431C19.7705 20.3527 20.4153 19.6975 21.2161 19.6871C22.0065 19.6767 22.6617 20.3215 22.6721 21.1119Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M41.2672 21.1329C41.2776 21.9337 40.6432 22.5785 39.8424 22.5889C39.0208 22.5993 38.3552 21.9545 38.3552 21.1329C38.3552 20.3425 39.0208 19.6977 39.8112 19.6873C40.6016 19.6873 41.2568 20.3425 41.2672 21.1329Z"
                        fill="#F9FCFC"
                      />
                    </g>
                    <defs>
                  ...
                  <h2 className="text-white font-semibold text-xl">Keynote Addresses</h2>
                  <p className="text-white text-md">
                    Visionary keynote speakers will set the stage for
                    discussions on the future of AI in Africa and the diaspora.
                  </p>
                </div>
                <div className="highlights-card space-y-4 border-b-2 border-r-2 border-solid border-b-[#F39711CC] border-r-[#F39711CC] p-5">
                  <svg
                  ...
                  <h2 className="text-white font-semibold text-xl">Panel Discussions</h2>
                  <p className="text-white text-md">
                    Expert panels will delve deep into topics such as AI policy,
                    the role of AI in sustainable development, data
              ...
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="highlights-card space-y-4 border-b-2 border-b-[#F39711CC] md:border-b-0 border-r-2 border-solid  border-r-[#F39711CC] p-5">
                  ...
                  >
                    <g clip-path="url(#clip0_135_702)">
                      ...
                      />
                      <path
                        d="M14.1025 12.3449C14.1025 15.2465 11.7209 17.6177 8.81927 17.6177C5.89687 17.6177 3.51527 15.2257 3.52567 12.2929C3.54647 9.4017 5.92807 7.0409 8.84007 7.0513C11.7417 7.0617 14.1025 9.4433 14.1025 12.3449Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M24.6687 33.4878C27.1023 33.4878 29.0783 35.4638 29.0783 37.887C29.0783 40.3102 27.1023 42.2966 24.6791 42.2966C22.2559 42.2966 20.2695 40.3206 20.2695 37.8974C20.2695 35.4742 22.2455 33.4878 24.6687 33.4878Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M44.0649 42.2966C41.6417 42.2966 39.6553 40.3206 39.6553 37.8974C39.6553 35.4742 41.6313 33.4878 44.0545 33.4878C46.4881 33.4878 48.4641 35.4638 48.4641 37.887C48.4745 40.3206 46.4985 42.2966 44.0649 42.2966Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="
z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M33.488 3.952C33.488 2.6312 33.488 2.6416 34.8296 2.6416C35.1416 2.6416 35.2872 2.6832 35.2664 3.0472C35.2352 3.6712 35.2456 4.2952 35.2664 4.9192C35.2768 5.1896 35.2248 5.3456 34.9128 5.2936C34.892 5.2936 34.8712 5.2936 34.8608 5.2936C33.488 5.3144 33.488 5.3144 33.488 3.952Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M23.3273 15.8598C22.0273 15.8598 22.0377 15.8598 22.0273 14.5598C22.0169 14.175 22.1209 14.0606 22.5057 14.0814C23.1297 14.1126 23.7537 14.1022 24.3777 14.0814C24.6169 14.071 24.7209 14.1542 24.6793 14.3934C24.6793 14.4142 24.6793 14.435 24.6793 14.4454C24.7209 15.8598 24.7209 15.8598 23.3273 15.8598Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M45.3439 15.8602C44.0543 15.8602 44.0751 15.8602 44.0647 14.5394C44.0647 14.1858 44.1375 14.061 44.5119 14.0818C45.1359 14.113 45.7599 14.1026 46.3839 14.0818C46.6439 14.0714 46.7167 14.1442 46.7271 14.4146C46.7791 15.8602 46.7895 15.8602 45.3439 15.8602Z"
                        fill="#F9FCFC"
                      />
                    </g>
                    <defs>
                ...
                <div className="highlights-card space-y-4  border-b-2 border-b-[#F39711CC] md:border-b-0 border-r-2 border-solid border-r-[#F39711CC] p-5">
                  ...
                  <h2 className="text-white font-semibold text-xl">Networking</h2>
                  <p className="text-white text-md">
                    Extensive networking opportunities for participants to
                    connect, collaborate, and explore partnerships.
                  </p>
                </div>
                <div className="highlights-card space-y-4  border-b-2 border-b-[#F39711CC] border-r-2 border-solid border-r-[#F39711CC] md:border-b-0 md:border-r-0 p-5">
                  ...
                  >
                    <g clip-path="url(#clip0_135_659)">
                      ...
                      />
                      <path
                        d="M18.2105 13.1353C17.3785 10.6913 18.6785 8.12246 21.0809 7.38406C21.4033 7.29046 21.5385 7.26966 21.5281 7.68566C21.4969 8.72566 21.5177 9.76566 21.5177 10.8161C21.5177 11.0345 21.4865 11.1905 21.2681 11.3153C20.2593 11.8977 19.2609 12.5009 18.2105 13.1353Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M23.3066 7.31104C25.0226 7.60224 26.4578 9.02703 26.7594 10.7638C25.6986 10.7638 24.6378 10.7638 23.5874 10.7638C23.369 10.7638 23.2962 10.7014 23.3066 10.483C23.317 9.43264 23.3066 8.37184 23.3066 7.31104Z"
                        fill="#F9FCFC"
                      />
                      <path
                        d="M17.9609 41.2358C18.4497 41.2358 18.9281 41.2462 19.4169 41.2358C19.6561 41.2254 19.7393 41.2982 19.7289 41.5478C19.7081 42.0678 19.7393 42.5878 19.7185 43.1078C19.6769 44.075 18.8761 44.8238 17.9297 44.8238C16.9833 44.8238 16.1825 44.0646 16.1513 43.1078C16.1305 42.5878 16.1617 42.0678 16.1409 41.5478C16.1305 41.2982 16.2241 41.2358 16.4633 41.2358C16.9521 41.2462 17.4617 41.2358 17.9609 41.2358Z"
                        fill="#F9FCFC"
                      />
                    </g>
                    <defs>
                  ...
                  <h2 className="text-white font-semibold text-xl">Innovation Showcase</h2>
                  <p className="text-white  text-md">
                    Exhibitions showcasing innovative AI solutions and
                    technologies.
                  </p>
                </div>
              </div>
        ...
        <section class="contact" id="contact-id">
          <div class="contact-container flex flex-col md:flex-row items-start justify-between">
